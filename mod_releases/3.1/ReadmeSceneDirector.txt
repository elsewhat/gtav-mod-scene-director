Scene director3.0 release by elsewhat
...
Starting with version 3.0 you can record the gun fire actions of each actor in the scene.
(make sure you as a player is not controlling any actor with gun fire recording)
