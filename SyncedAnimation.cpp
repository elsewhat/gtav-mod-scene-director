...
void initializeSyncedAnimations() {
	gtaSyncedAnimations = { 
		SyncedAnimation("Grab money, duffel (exit)", "", true, std::vector<Animation> {getAnimationForShortcutIndex(25702),}, std::vector<Animation> {getAnimationForShortcutIndex(25699),getAnimationForShortcutIndex(1462),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_ld_heist_bag_s_1"),getGTAObjectFromObjName("p_csh_strap_03_s"),}, -1),
		SyncedAnimation("Grab money, duffel (loop)", "", true, std::vector<Animation> {getAnimationForShortcutIndex(1463),}, std::vector<Animation> {getAnimationForShortcutIndex(1464),getAnimationForShortcutIndex(1467),getAnimationForShortcutIndex(1465),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_ld_heist_bag_s_1"),getGTAObjectFromObjName("p_csh_strap_03_s"),getGTAObjectFromObjName("prop_anim_cash_pile_02"),}, -1),
		SyncedAnimation("Grab money, duffel (enter)", "", true, std::vector<Animation> {getAnimationForShortcutIndex(1461),}, std::vector<Animation> {getAnimationForShortcutIndex(25701),getAnimationForShortcutIndex(25700),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_ld_heist_bag_s_1"),getGTAObjectFromObjName("p_csh_strap_03_s"),}, -1),
		SyncedAnimation("Dock beatup #2", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10672),getAnimationForShortcutIndex(10673),getAnimationForShortcutIndex(10674),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Dock beatup #1", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10665),getAnimationForShortcutIndex(10666),getAnimationForShortcutIndex(10667),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Leg massage", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10609),getAnimationForShortcutIndex(10608),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Back massage", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10583),getAnimationForShortcutIndex(10582),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Enterboat stealth", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10576),}, std::vector<Animation> {getAnimationForShortcutIndex(10578),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_po1_01_doorm_s"),}, 0),
		SyncedAnimation("Enterboat action", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10573),}, std::vector<Animation> {getAnimationForShortcutIndex(10575),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_po1_01_doorm_s"),}, 0),
		SyncedAnimation("Stab guard", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10563),getAnimationForShortcutIndex(10562),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Rocking chair #4", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10532),}, std::vector<Animation> {getAnimationForShortcutIndex(10533),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ret_fh_chair01"),}, -0.6),
		SyncedAnimation("Rocking chair #3", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10530),}, std::vector<Animation> {getAnimationForShortcutIndex(10531),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ret_fh_chair01"),}, -0.6),
		SyncedAnimation("Rocking chair #2", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10528),}, std::vector<Animation> {getAnimationForShortcutIndex(10529),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ret_fh_chair01"),}, -0.6),
		SyncedAnimation("Rocking chair #1", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10526),}, std::vector<Animation> {getAnimationForShortcutIndex(10527),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ret_fh_chair01"),}, -0.6),
		SyncedAnimation("Run out door", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10385),}, std::vector<Animation> {getAnimationForShortcutIndex(10380),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_fh_door02"),}, 0),
		SyncedAnimation("Pull to feet (dead)", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10372),getAnimationForShortcutIndex(10370),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Pull to feet (alive)", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10363),getAnimationForShortcutIndex(10361),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Idle at computer #3", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10267),}, std::vector<Animation> {getAnimationForShortcutIndex(10262),getAnimationForShortcutIndex(10263),getAnimationForShortcutIndex(10266),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_clb_officechair_s"),getGTAObjectFromObjName("prop_cs_keyboard_01"),getGTAObjectFromObjName("prop_cs_mouse_01"),}, -1),
		SyncedAnimation("Idle at computer #2", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10261),}, std::vector<Animation> {getAnimationForShortcutIndex(10256),getAnimationForShortcutIndex(10257),getAnimationForShortcutIndex(10260),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_clb_officechair_s"),getGTAObjectFromObjName("prop_cs_keyboard_01"),getGTAObjectFromObjName("prop_cs_mouse_01"),}, -1),
		SyncedAnimation("Idle at computer #1", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10249),}, std::vector<Animation> {getAnimationForShortcutIndex(10244),getAnimationForShortcutIndex(10245),getAnimationForShortcutIndex(10248),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_clb_officechair_s"),getGTAObjectFromObjName("prop_cs_keyboard_01"),getGTAObjectFromObjName("prop_cs_mouse_01"),}, -1),
		SyncedAnimation("Break door axe #2", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10199),getAnimationForShortcutIndex(10198),getAnimationForShortcutIndex(10197),}, std::vector<Animation> {getAnimationForShortcutIndex(10196),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_ld_fireaxe"),}, -1),
		SyncedAnimation("Break door axe #1", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10190),getAnimationForShortcutIndex(10188),getAnimationForShortcutIndex(10189),}, std::vector<Animation> {getAnimationForShortcutIndex(10187),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_ld_fireaxe"),}, -1),
		SyncedAnimation("Throw helmet", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10160),getAnimationForShortcutIndex(10159),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -0.7),
		SyncedAnimation("Hairdressers haircut", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10086),getAnimationForShortcutIndex(10075),}, std::vector<Animation> {getAnimationForShortcutIndex(10096),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_serv_bs_scissors"),}, -1),
		SyncedAnimation("Hairdressers sitdown", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10044),getAnimationForShortcutIndex(10037),}, std::vector<Animation> {getAnimationForShortcutIndex(10052),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_serv_bs_scissors"),}, -1),
		SyncedAnimation("Hairdressers leave", "", true, std::vector<Animation> {getAnimationForShortcutIndex(10028),getAnimationForShortcutIndex(10041),}, std::vector<Animation> {getAnimationForShortcutIndex(10031),getAnimationForShortcutIndex(10056),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_bs_door"),getGTAObjectFromObjName("v_serv_bs_scissors"),}, -1),
		SyncedAnimation("Open door (strip club)", "", true, std::vector<Animation> {getAnimationForShortcutIndex(9997),}, std::vector<Animation> {getAnimationForShortcutIndex(9999),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_strip_door_01"),}, 0.2),
		SyncedAnimation("Get out of van with dog", "", true, std::vector<Animation> {getAnimationForShortcutIndex(9924),getAnimationForShortcutIndex(9923),getAnimationForShortcutIndex(9925),}, std::vector<Animation> {getAnimationForShortcutIndex(9926),}, std::vector<GTAObject> {getGTAObjectFromObjName("speedo"),}, -0.2),
		...
		SyncedAnimation("Throw passengers phone", "<select category>", false, std::vector<Animation> {getAnimationForShortcutIndex(9915),getAnimationForShortcutIndex(9916),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Wheelchair - use computer", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9897),}, std::vector<Animation> {getAnimationForShortcutIndex(9898),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_wheelchair_01"),}, -1),
		SyncedAnimation("Wheelchair - turn left", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9895),}, std::vector<Animation> {getAnimationForShortcutIndex(9896),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_wheelchair_01"),}, -1),
		SyncedAnimation("Wheelchair - stationary", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9893),}, std::vector<Animation> {getAnimationForShortcutIndex(9894),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_wheelchair_01"),}, -1),
		SyncedAnimation("Wheelchair - turn right", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9889),}, std::vector<Animation> {getAnimationForShortcutIndex(9890),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_wheelchair_01"),}, -1),
		SyncedAnimation("Get in back of van with dog", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9988),getAnimationForShortcutIndex(9987),}, std::vector<Animation> {getAnimationForShortcutIndex(9989),}, std::vector<GTAObject> {getGTAObjectFromObjName("speedo"),}, -0.2),
		SyncedAnimation("Dogs humping exit #2", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9966),getAnimationForShortcutIndex(9968),getAnimationForShortcutIndex(9967),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -0.55),
		SyncedAnimation("Dogs humping exit #1", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9963),getAnimationForShortcutIndex(9964),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -0.55),
		SyncedAnimation("Dogs humping loop", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9969),getAnimationForShortcutIndex(9970),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -0.55),
		SyncedAnimation("Dogs humping enter", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9961),getAnimationForShortcutIndex(9962),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -0.55),
		SyncedAnimation("Push car", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9846),getAnimationForShortcutIndex(9847),getAnimationForShortcutIndex(9848),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -0.5),
		SyncedAnimation("Devin hide in box #2", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9840),}, std::vector<Animation> {getAnimationForShortcutIndex(9839),getAnimationForShortcutIndex(9841),}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Devin hide in box #1", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9837),}, std::vector<Animation> {getAnimationForShortcutIndex(9836),getAnimationForShortcutIndex(9838),}, std::vector<GTAObject> {getGTAObjectFromObjName("box"),getGTAObjectFromObjName("tablet"),}, 0),
		SyncedAnimation("Michael's death (headbutt)", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9822),getAnimationForShortcutIndex(9823),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1.2),
		SyncedAnimation("Michael's death (dropped)", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9820),getAnimationForShortcutIndex(9821),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1.2),
		SyncedAnimation("Michael's death (hanging)", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9824),getAnimationForShortcutIndex(9826),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1.2),
		SyncedAnimation("Show ID", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9740),getAnimationForShortcutIndex(9739),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		...
		SyncedAnimation("Double doors (two actors)", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9683),getAnimationForShortcutIndex(9684),}, std::vector<Animation> {getAnimationForShortcutIndex(9685),getAnimationForShortcutIndex(9686),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_bl_door_l"),getGTAObjectFromObjName("v_ilev_bl_door_r"),}, 0),
		SyncedAnimation("Insert chemical", "", true, std::vector<Animation> {getAnimationForShortcutIndex(9667),}, std::vector<Animation> {getAnimationForShortcutIndex(9668),getAnimationForShortcutIndex(9669),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_vial_01"),getGTAObjectFromObjName("p_chem_vial_02b_s"),}, -0.4),
		SyncedAnimation("Take chemical", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9632),}, std::vector<Animation> {getAnimationForShortcutIndex(9634),getAnimationForShortcutIndex(9635),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_vial_01"),getGTAObjectFromObjName("p_chem_vial_02b_s"),}, -0.4),
		SyncedAnimation("Holdup (press button)", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9625),getAnimationForShortcutIndex(9627),getAnimationForShortcutIndex(9626),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Holdup (scientist walking #2)", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9622),getAnimationForShortcutIndex(9621),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Holdup (use keycard)", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9608),getAnimationForShortcutIndex(9610),getAnimationForShortcutIndex(9609),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Move through labs #2", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9606),getAnimationForShortcutIndex(9607),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Driver tells passenger to stop", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9605),getAnimationForShortcutIndex(9604),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Driver sad, push passenger away", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9603),getAnimationForShortcutIndex(9602),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Holdup (scientist walking #1)", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9598),getAnimationForShortcutIndex(9601),getAnimationForShortcutIndex(9599),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Holdup (scientists working #1)", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9587),getAnimationForShortcutIndex(9590),getAnimationForShortcutIndex(9591),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Scientists working #3", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9585),getAnimationForShortcutIndex(9586),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Scientists working #2", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9581),getAnimationForShortcutIndex(9582),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Scientists working #1", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9579),getAnimationForShortcutIndex(9580),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Scientists working base", "", true, std::vector<Animation> {getAnimationForShortcutIndex(9583),getAnimationForShortcutIndex(9584),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Move through labs #1", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9575),getAnimationForShortcutIndex(9576),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Holdup (humane elevator #2)", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9570),getAnimationForShortcutIndex(9567),getAnimationForShortcutIndex(9571),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Holdup (humane elevator #1)", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9564),getAnimationForShortcutIndex(9569),getAnimationForShortcutIndex(9565),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Driver crying #2", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9563),getAnimationForShortcutIndex(9561),}, std::vector<Animation> {getAnimationForShortcutIndex(9559),}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Driver crying #1", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9562),getAnimationForShortcutIndex(9560),}, std::vector<Animation> {getAnimationForShortcutIndex(9558),}, std::vector<GTAObject> {getGTAObjectFromObjName("bodhi"),}, 0),
		SyncedAnimation("Take off mask", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9508),}, std::vector<Animation> {getAnimationForShortcutIndex(9509),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_trev_ski_mask_s"),}, 0),
		SyncedAnimation("Torture, wrench #3", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9476),getAnimationForShortcutIndex(9478),}, std::vector<Animation> {getAnimationForShortcutIndex(9473),getAnimationForShortcutIndex(9480),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_torture_ch_01"),getGTAObjectFromObjName("prop_tool_wrench"),}, 0),
		SyncedAnimation("Torture, wrench #2", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9467),getAnimationForShortcutIndex(9469),}, std::vector<Animation> {getAnimationForShortcutIndex(9464),getAnimationForShortcutIndex(9471),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_torture_ch_01"),getGTAObjectFromObjName("prop_tool_wrench"),}, 0),
		SyncedAnimation("Torture, wrench #1", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(9458),getAnimationForShortcutIndex(9460),}, std::vector<Animation> {getAnimationForShortcutIndex(9455),getAnimationForShortcutIndex(9462),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_torture_ch_01"),getGTAObjectFromObjName("prop_tool_wrench"),}, 0),
		SyncedAnimation("Torture, wrench intro", "", true, std::vector<Animation> {getAnimationForShortcutIndex(9485),getAnimationForShortcutIndex(9487),}, std::vector<Animation> {getAnimationForShortcutIndex(9482),getAnimationForShortcutIndex(9488),}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Drink whiskey #5 shot", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13944),}, std::vector<Animation> {getAnimationForShortcutIndex(13949),getAnimationForShortcutIndex(13951),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_whiskey_bottle"),getGTAObjectFromObjName("prop_sh_shot_glass"),}, 0),
		SyncedAnimation("Drink whiskey #4 shot", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13960),}, std::vector<Animation> {getAnimationForShortcutIndex(13965),getAnimationForShortcutIndex(13967),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_whiskey_bottle"),getGTAObjectFromObjName("prop_sh_shot_glass"),}, 0),
		SyncedAnimation("Drink whiskey #3 shot", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13980),}, std::vector<Animation> {getAnimationForShortcutIndex(13985),getAnimationForShortcutIndex(13987),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_whiskey_bottle"),getGTAObjectFromObjName("prop_sh_shot_glass"),}, 0),
		SyncedAnimation("Drink whiskey #2 shot", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13968),}, std::vector<Animation> {getAnimationForShortcutIndex(13973),getAnimationForShortcutIndex(13975),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_whiskey_bottle"),getGTAObjectFromObjName("prop_sh_shot_glass"),}, 0),
		SyncedAnimation("Drink whiskey #1 shot", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13952),}, std::vector<Animation> {getAnimationForShortcutIndex(13957),getAnimationForShortcutIndex(13959),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_whiskey_bottle"),getGTAObjectFromObjName("prop_sh_shot_glass"),}, 0),
		...
		SyncedAnimation("Kisses", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13678),getAnimationForShortcutIndex(13679),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Hugs", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13675),getAnimationForShortcutIndex(13676),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("High five", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13672),getAnimationForShortcutIndex(13673),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Handshake", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13669),getAnimationForShortcutIndex(13670),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Shoot out", "<select category>", false, std::vector<Animation> {getAnimationForShortcutIndex(13633),getAnimationForShortcutIndex(13634),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Walk into vault", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13627),}, std::vector<Animation> {getAnimationForShortcutIndex(13628),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_cbankvauldoor01"),}, -0.9),
		SyncedAnimation("Heist ruralbank", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13617),getAnimationForShortcutIndex(13618),}, std::vector<Animation> {getAnimationForShortcutIndex(13619),getAnimationForShortcutIndex(13620),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_cbankcountdoor01"),getGTAObjectFromObjName("v_ilev_cbankvauldoor01"),}, -0.9),
		SyncedAnimation("Lamar's introduction to multiplayer male", "<select category>", false, std::vector<Animation> {getAnimationForShortcutIndex(13530),getAnimationForShortcutIndex(13531),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -0.5),
		SyncedAnimation("Lamar's introduction to multiplayer female", "<select category>", false, std::vector<Animation> {getAnimationForShortcutIndex(13528),getAnimationForShortcutIndex(13529),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -0.5),
		SyncedAnimation("Exit door right", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13426),}, std::vector<Animation> {getAnimationForShortcutIndex(13425),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_fh_door02"),}, 0.1),
		SyncedAnimation("Exit door left", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13422),}, std::vector<Animation> {getAnimationForShortcutIndex(13421),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_fh_door02"),}, 0.1),
		SyncedAnimation("Enter door right", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13418),}, std::vector<Animation> {getAnimationForShortcutIndex(13417),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_fh_door02"),}, 0.1),
		SyncedAnimation("Enter door left #2", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13414),}, std::vector<Animation> {getAnimationForShortcutIndex(13413),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_fh_door02"),}, 0.1),
		SyncedAnimation("Enter door left #1", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13411),}, std::vector<Animation> {getAnimationForShortcutIndex(13410),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_fh_door02"),}, 0.1),
		SyncedAnimation("Enter house", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13339),getAnimationForShortcutIndex(13402),getAnimationForShortcutIndex(13403),}, std::vector<Animation> {getAnimationForShortcutIndex(13401),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_fh_door02"),}, -1),
		SyncedAnimation("Buzz in friend", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13392),getAnimationForShortcutIndex(13393),}, std::vector<Animation> {getAnimationForShortcutIndex(13391),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_fh_door02"),}, 0.1),
		SyncedAnimation("Car bomb install", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13235),}, std::vector<Animation> {getAnimationForShortcutIndex(13234),}, std::vector<GTAObject> {getGTAObjectFromObjName("w_ex_pe"),}, 0),
		SyncedAnimation("Arrest on floor front-right", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13192),getAnimationForShortcutIndex(13193),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Arrest on floor front-left", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13188),getAnimationForShortcutIndex(13189),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Arrest on floor back-right", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13184),getAnimationForShortcutIndex(13185),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Arrest on floor back-left", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13180),getAnimationForShortcutIndex(13181),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Arrest forward-right", "<select category>", false, std::vector<Animation> {getAnimationForShortcutIndex(13162),getAnimationForShortcutIndex(13175),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Arrest forward-left", "<select category>", false, std::vector<Animation> {getAnimationForShortcutIndex(13161),getAnimationForShortcutIndex(13174),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Arrest back-right", "<select category>", false, std::vector<Animation> {getAnimationForShortcutIndex(13159),getAnimationForShortcutIndex(13173),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Arrest back-left", "<select category>", false, std::vector<Animation> {getAnimationForShortcutIndex(13158),getAnimationForShortcutIndex(13172),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		...
		SyncedAnimation("Purchase energydrink", "<select category>", true, std::vector<Animation> {}, std::vector<Animation> {getAnimationForShortcutIndex(13118),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_ecola_can"),}, 0),
		SyncedAnimation("Purchase cigarette", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13117),}, std::vector<Animation> {getAnimationForShortcutIndex(13116),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_fag_packet_01"),}, 0),
		SyncedAnimation("Purchase chocbar", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13115),}, std::vector<Animation> {getAnimationForShortcutIndex(13114),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_choc_ego"),}, 0),
		SyncedAnimation("Purchase beerbox", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13113),}, std::vector<Animation> {getAnimationForShortcutIndex(13112),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ret_ml_beerjak2"),}, 0),
		SyncedAnimation("Purchase beer", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13111),}, std::vector<Animation> {getAnimationForShortcutIndex(13110),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_beer_pissh"),}, 0),
		SyncedAnimation("Store hold up cash", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(13107),}, std::vector<Animation> {getAnimationForShortcutIndex(13108),getAnimationForShortcutIndex(13109),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_poly_bag_01_s"),getGTAObjectFromObjName("p_till_01_s"),}, 0),
		SyncedAnimation("Jump out of van", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12289),getAnimationForShortcutIndex(12290),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -0.2),
		SyncedAnimation("Dive clear", "<select category>", false, std::vector<Animation> {getAnimationForShortcutIndex(12281),getAnimationForShortcutIndex(12282),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		...
		SyncedAnimation("Beatup dockworker idle", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12261),getAnimationForShortcutIndex(12262),getAnimationForShortcutIndex(12263),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Beatup dockworker exit", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12258),getAnimationForShortcutIndex(12259),getAnimationForShortcutIndex(12260),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Beatup dockworker main", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12264),getAnimationForShortcutIndex(12265),getAnimationForShortcutIndex(12266),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Beatup dockworker intro", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12267),getAnimationForShortcutIndex(12268),getAnimationForShortcutIndex(12269),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("misstrevor3 bike_chat_b_outro_1 outro", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12245),getAnimationForShortcutIndex(12246),}, std::vector<Animation> {getAnimationForShortcutIndex(12247),getAnimationForShortcutIndex(12248),}, std::vector<GTAObject> {getGTAObjectFromObjName("daemon"),getGTAObjectFromObjName("daemon"),}, -1),
		SyncedAnimation("misstrevor3 bike_chat_b_loop_1 loop", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12240),getAnimationForShortcutIndex(12241),}, std::vector<Animation> {getAnimationForShortcutIndex(12242),getAnimationForShortcutIndex(12243),}, std::vector<GTAObject> {getGTAObjectFromObjName("daemon"),getGTAObjectFromObjName("daemon"),}, -1),
		SyncedAnimation("misstrevor3 bike_chat_a_1 intro", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12236),getAnimationForShortcutIndex(12237),}, std::vector<Animation> {getAnimationForShortcutIndex(12238),getAnimationForShortcutIndex(12239),}, std::vector<GTAObject> {getGTAObjectFromObjName("daemon"),getGTAObjectFromObjName("daemon"),}, -1),
		SyncedAnimation("call_biker_biker", "<select category>", false, std::vector<Animation> {getAnimationForShortcutIndex(12197),getAnimationForShortcutIndex(12198),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("bikers_from_van_peda", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12173),getAnimationForShortcutIndex(12174),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -0.1),
		SyncedAnimation("bikers_from_van_ped_a", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12171),getAnimationForShortcutIndex(12172),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -0.1),
		SyncedAnimation("jump_out_of_van_ds", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12169),getAnimationForShortcutIndex(12170),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -0.1),
		SyncedAnimation("dialogue_b_ron", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12157),getAnimationForShortcutIndex(12156),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("threaten_ortega_trev", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12107),getAnimationForShortcutIndex(12106),getAnimationForShortcutIndex(12105),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Enter home #2", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12066),}, std::vector<Animation> {getAnimationForShortcutIndex(12069),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_fh_door02"),}, 0.1),
		SyncedAnimation("Enter home #1", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12062),}, std::vector<Animation> {getAnimationForShortcutIndex(12064),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_fh_door02"),}, 0.1),
		SyncedAnimation("Tattoo #2", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(14856),getAnimationForShortcutIndex(14857),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Enter shop", "", true, std::vector<Animation> {getAnimationForShortcutIndex(12058),getAnimationForShortcutIndex(12059),}, std::vector<Animation> {getAnimationForShortcutIndex(12060),getAnimationForShortcutIndex(12057),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_ta_door"),getGTAObjectFromObjName("v_ilev_ta_door"),}, -1),
		SyncedAnimation("artist_finishes_up_his_tattoo_artist", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12055),getAnimationForShortcutIndex(1253),}, std::vector<Animation> {getAnimationForShortcutIndex(12054),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_ta_door"),}, -1),
		SyncedAnimation("shop_ig_4_customer", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12042),getAnimationForShortcutIndex(12045),}, std::vector<Animation> {getAnimationForShortcutIndex(12043),getAnimationForShortcutIndex(12044),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_ta_door"),getGTAObjectFromObjName("v_ilev_ta_tatgun"),}, -1),
		SyncedAnimation("mid_mission_inside_helicopter_lester ", "<select category>", true, std::vector<Animation> {getAnimationForShortcutIndex(12036),getAnimationForShortcutIndex(12037),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Miss switch in car", "<select category>", false, std::vector<Animation> {getAnimationForShortcutIndex(12031),getAnimationForShortcutIndex(12032),getAnimationForShortcutIndex(12030),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		...
		SyncedAnimation("Open garage door", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(7755),}, std::vector<Animation> {getAnimationForShortcutIndex(7754),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_gar_door_03_ld"),}, 0),
		...
		SyncedAnimation("Pimp demands money", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(6862),getAnimationForShortcutIndex(6864),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
