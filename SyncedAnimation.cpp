...
void initializeSyncedAnimations() {
	gtaSyncedAnimations = { 
		...
		SyncedAnimation("Rocking chair #1", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(10526),}, std::vector<Animation> {getAnimationForShortcutIndex(10527),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_rock_chair_01"),}, -0.6),
		SyncedAnimation("Rocking chair #2", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(10528),}, std::vector<Animation> {getAnimationForShortcutIndex(10529),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_rock_chair_01"),}, -0.6),
		SyncedAnimation("Rocking chair #3", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(10530),}, std::vector<Animation> {getAnimationForShortcutIndex(10531),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_rock_chair_01"),}, -0.6),
		SyncedAnimation("Rocking chair #4", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(10532),}, std::vector<Animation> {getAnimationForShortcutIndex(10533),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_rock_chair_01"),}, -0.6),
		...
		SyncedAnimation("Gang intimidation", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(14609),getAnimationForShortcutIndex(14610),getAnimationForShortcutIndex(14611),}, std::vector<Animation> {}, std::vector<GTAObject> {getGTAObjectFromObjName("fbi2"),}, 0),
		SyncedAnimation("Put prisoner in police car, loop", "Vehicle", true, std::vector<Animation> {getAnimationForShortcutIndex(14633),getAnimationForShortcutIndex(14635),getAnimationForShortcutIndex(14634),}, std::vector<Animation> {}, std::vector<GTAObject> {getGTAObjectFromObjName("fbi2"),}, -0.3),
		SyncedAnimation("Put prisoner in police car, exit", "Vehicle", true, std::vector<Animation> {getAnimationForShortcutIndex(14630),getAnimationForShortcutIndex(14632),getAnimationForShortcutIndex(14631),}, std::vector<Animation> {getAnimationForShortcutIndex(14629),}, std::vector<GTAObject> {getGTAObjectFromObjName("fbi2"),}, -0.3),
		...
		SyncedAnimation("Weed depository", "Other", true, std::vector<Animation> {getAnimationForShortcutIndex(17089),getAnimationForShortcutIndex(17091),}, std::vector<Animation> {getAnimationForShortcutIndex(17092),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_weed_bottle_s"),}, -0.4),
		SyncedAnimation("Talking to taxi passenger", "Vehicle", true, std::vector<Animation> {getAnimationForShortcutIndex(17109),getAnimationForShortcutIndex(17110),}, std::vector<Animation> {getAnimationForShortcutIndex(17111),}, std::vector<GTAObject> {getGTAObjectFromObjName("taxi"),}, 0),
		SyncedAnimation("Gang taunt loop", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17154),getAnimationForShortcutIndex(17155),getAnimationForShortcutIndex(17156),getAnimationForShortcutIndex(17157),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Gang taunt exit", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17149),getAnimationForShortcutIndex(17150),getAnimationForShortcutIndex(17151),getAnimationForShortcutIndex(17152),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Stop gang fight loop", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17165),getAnimationForShortcutIndex(17168),getAnimationForShortcutIndex(17166),getAnimationForShortcutIndex(17167),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Stop gang fight exit", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17160),getAnimationForShortcutIndex(17163),getAnimationForShortcutIndex(17161),getAnimationForShortcutIndex(16162),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Shoved by gangster", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17198),getAnimationForShortcutIndex(17199),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Toss garbage bag", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(17211),}, std::vector<Animation> {getAnimationForShortcutIndex(17209),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_rub_binbag_01"),}, -1),
		SyncedAnimation("Toss cup", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(17225),}, std::vector<Animation> {getAnimationForShortcutIndex(17227),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_ing_coffeecup_01"),}, 0),
		SyncedAnimation("Ironing clothes loop", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(17231),}, std::vector<Animation> {getAnimationForShortcutIndex(17233),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_ironing_board"),}, -0.55),
		SyncedAnimation("Ironing clothes exit", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(17234),}, std::vector<Animation> {getAnimationForShortcutIndex(17237),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_ironing_board"),}, -0.55),
		SyncedAnimation("Shut laptop, loop", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(17259),}, std::vector<Animation> {getAnimationForShortcutIndex(17261),getAnimationForShortcutIndex(17260),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_cs_laptop_02"),getGTAObjectFromObjName("p_clb_officechair_s"),}, 0),
		SyncedAnimation("Shut laptop, exit", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(17254),}, std::vector<Animation> {getAnimationForShortcutIndex(17258),getAnimationForShortcutIndex(17256),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_cs_laptop_02"),getGTAObjectFromObjName("p_clb_officechair_s"),}, 0),
		SyncedAnimation("Tanisha argument", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17304),getAnimationForShortcutIndex(17305),}, std::vector<Animation> {getAnimationForShortcutIndex(17307),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_fa_frontdoor"),}, 0.1),
		...
		SyncedAnimation("Upset talking in bed, exit 1", "Friendly interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17370),getAnimationForShortcutIndex(17376),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Upset talking in bed, exit 2", "Friendly interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17384),getAnimationForShortcutIndex(17379),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Upset talking in bed, loop 1", "Friendly interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17375),getAnimationForShortcutIndex(17373),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Upset talking in bed, loop 2", "Friendly interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17387),getAnimationForShortcutIndex(17385),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Gaming together", "Friendly interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17478),getAnimationForShortcutIndex(17477),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Gaming ragequit", "Friendly interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17475),getAnimationForShortcutIndex(17474),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Get out of bed, playful", "Friendly interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17482),getAnimationForShortcutIndex(17479),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Wave goodbye", "Friendly interaction", false, std::vector<Animation> {getAnimationForShortcutIndex(17491),getAnimationForShortcutIndex(17487),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Couple on loungechairs, loop", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17502),getAnimationForShortcutIndex(17499),}, std::vector<Animation> {getAnimationForShortcutIndex(17500),getAnimationForShortcutIndex(17501),}, std::vector<GTAObject> {getGTAObjectFromObjName("lounchchaira"),getGTAObjectFromObjName("lounchchairb"),}, 0),
		SyncedAnimation("Couple on loungechairs, exit", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17498),getAnimationForShortcutIndex(17494),}, std::vector<Animation> {getAnimationForShortcutIndex(17496),getAnimationForShortcutIndex(17497),}, std::vector<GTAObject> {getGTAObjectFromObjName("lounchchaira"),getGTAObjectFromObjName("lounchchairb"),}, 0),
		SyncedAnimation("Pat on back", "Friendly interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17516),getAnimationForShortcutIndex(17515),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Open door for passenger", "Vehicle", true, std::vector<Animation> {getAnimationForShortcutIndex(17527),getAnimationForShortcutIndex(17524),}, std::vector<Animation> {getAnimationForShortcutIndex(17526),}, std::vector<GTAObject> {getGTAObjectFromObjName("tailgater"),}, 0),
		SyncedAnimation("No smoking allowed", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17531),getAnimationForShortcutIndex(17533),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Throw cigarette over railing", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17546),}, std::vector<Animation> {getAnimationForShortcutIndex(17548),}, std::vector<GTAObject> {getGTAObjectFromObjName("bg_proc_cigarette01a"),}, 0),
		SyncedAnimation("Show wedding ring to hooker", "Other", true, std::vector<Animation> {getAnimationForShortcutIndex(17555),getAnimationForShortcutIndex(17554),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Read script on bed, loop", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(17560),}, std::vector<Animation> {getAnimationForShortcutIndex(17562),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_cs_script_s"),}, 0),
		SyncedAnimation("Read script on bed, exit", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(17556),}, std::vector<Animation> {getAnimationForShortcutIndex(17559),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_cs_script_s"),}, 0),
		SyncedAnimation("Rejected entry", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17566),getAnimationForShortcutIndex(17563),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Leave table and kiss, loop", "Friendly interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17573),getAnimationForShortcutIndex(17569),}, std::vector<Animation> {getAnimationForShortcutIndex(17571),getAnimationForShortcutIndex(17572),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_chateau_chair_01"),getGTAObjectFromObjName("prop_chateau_chair_01"),}, 0),
		SyncedAnimation("Leave table and kiss, exit", "Friendly interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17579),getAnimationForShortcutIndex(17574),}, std::vector<Animation> {getAnimationForShortcutIndex(17577),getAnimationForShortcutIndex(17578),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_chateau_chair_01"),getGTAObjectFromObjName("prop_chateau_chair_01"),}, 0),
		SyncedAnimation("Comfort while kneeling, loop", "Friendly interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(14746),getAnimationForShortcutIndex(14752),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Comfort while kneeling, exit", "Friendly interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(14745),getAnimationForShortcutIndex(14750),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Hold hostage, loop", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(14756),getAnimationForShortcutIndex(14753),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Hold hostage, victim killed", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(14755),getAnimationForShortcutIndex(14751),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Give cash to passenger", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17652),getAnimationForShortcutIndex(17653),}, std::vector<Animation> {getAnimationForShortcutIndex(17647),getAnimationForShortcutIndex(17648),}, std::vector<GTAObject> {getGTAObjectFromObjName("tailgater"),getGTAObjectFromObjName("prop_cash_pile_02"),}, 0),
		SyncedAnimation("Annoy sunbathers", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17687),getAnimationForShortcutIndex(17686),getAnimationForShortcutIndex(17685),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Leave bar", "Drinking/drugs", true, std::vector<Animation> {getAnimationForShortcutIndex(17705),getAnimationForShortcutIndex(17697),}, std::vector<Animation> {getAnimationForShortcutIndex(17698),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_beer_bot_02"),}, 0),
		SyncedAnimation("Rub teddy in face", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(17718),getAnimationForShortcutIndex(17713),}, std::vector<Animation> {getAnimationForShortcutIndex(17717),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_mr_raspberry_01_s"),}, -1),
		SyncedAnimation("Spooning with floyd, exit 1", "Friendly interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17732),getAnimationForShortcutIndex(17731),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Spooning with floyd, exit 2", "Friendly interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17735),getAnimationForShortcutIndex(17734),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Spooning with floyd, loop", "Friendly interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17738),getAnimationForShortcutIndex(17737),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Block photograph", "Other", true, std::vector<Animation> {getAnimationForShortcutIndex(17749),getAnimationForShortcutIndex(17747),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Throw over bridge, loop", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17754),getAnimationForShortcutIndex(17755),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Throw over bridge, exit", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17757),getAnimationForShortcutIndex(17758),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Chase strippers out of club", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17765),getAnimationForShortcutIndex(17763),getAnimationForShortcutIndex(17764),getAnimationForShortcutIndex(17760),}, std::vector<Animation> {getAnimationForShortcutIndex(17762),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_strip_door_01"),}, 0.2),
		SyncedAnimation("Escorted out", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17792),getAnimationForShortcutIndex(17788),getAnimationForShortcutIndex(17790),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Console floyd #1", "Other", true, std::vector<Animation> {getAnimationForShortcutIndex(17807),getAnimationForShortcutIndex(17805),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Console floyd #2", "Other", true, std::vector<Animation> {getAnimationForShortcutIndex(17817),getAnimationForShortcutIndex(17815),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Flush foot", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17818),}, std::vector<Animation> {getAnimationForShortcutIndex(17802),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_toiletfoot_static"),}, 0),
		SyncedAnimation("Eat from trash", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(17832),}, std::vector<Animation> {getAnimationForShortcutIndex(17831),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_taco_02"),}, -1),
		SyncedAnimation("Guitar beatdown", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17838),getAnimationForShortcutIndex(17835),}, std::vector<Animation> {getAnimationForShortcutIndex(17837),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_acc_guitar_01_d1"),}, 0),
		SyncedAnimation("Strumming guitar", "Individual w/props", true, std::vector<Animation> {getAnimationForShortcutIndex(17839),}, std::vector<Animation> {getAnimationForShortcutIndex(17841),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_acc_guitar_01_d1"),}, 0.1),
		SyncedAnimation("Knockout against wall", "Advanced Melee", true, std::vector<Animation> {getAnimationForShortcutIndex(17855),getAnimationForShortcutIndex(17853),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0.1),
		SyncedAnimation("Throw pineapple", "Other", true, std::vector<Animation> {getAnimationForShortcutIndex(17890),getAnimationForShortcutIndex(17886),}, std::vector<Animation> {getAnimationForShortcutIndex(17889),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_pineapple"),}, 0),
		SyncedAnimation("Scare tramp", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17918),getAnimationForShortcutIndex(17917),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Steal and throw food", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17938),getAnimationForShortcutIndex(17935),}, std::vector<Animation> {getAnimationForShortcutIndex(17937),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_taco_01"),}, -1),
		SyncedAnimation("Grab by throat, throw over railing", "Aggressive interaction", true, std::vector<Animation> {getAnimationForShortcutIndex(17974),getAnimationForShortcutIndex(17972),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Drunk amanda #1", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17986),}, std::vector<Animation> {getAnimationForShortcutIndex(17987),getAnimationForShortcutIndex(17988),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_wine_bot_01"),getGTAObjectFromObjName("prop_wine_glass_s"),}, 0),
		SyncedAnimation("Drunk amanda #2", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17989),}, std::vector<Animation> {getAnimationForShortcutIndex(17990),getAnimationForShortcutIndex(17991),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_wine_bot_01"),getGTAObjectFromObjName("prop_wine_glass_s"),}, 0),
		SyncedAnimation("Drunk amanda #3", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17992),}, std::vector<Animation> {getAnimationForShortcutIndex(17993),getAnimationForShortcutIndex(17994),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_wine_bot_01"),getGTAObjectFromObjName("prop_wine_glass_s"),}, 0),
		SyncedAnimation("KO Train Driver TEST", "", true, std::vector<Animation> {getAnimationForShortcutIndex(8469),getAnimationForShortcutIndex(8471),}, std::vector<Animation> {getAnimationForShortcutIndex(8473),}, std::vector<GTAObject> {getGTAObjectFromObjName("freight"),}, 0),
		SyncedAnimation("Train Crash TEST", "", true, std::vector<Animation> {getAnimationForShortcutIndex(8475),}, std::vector<Animation> {getAnimationForShortcutIndex(44004),getAnimationForShortcutIndex(44002),getAnimationForShortcutIndex(43998),getAnimationForShortcutIndex(43999),getAnimationForShortcutIndex(44000),}, std::vector<GTAObject> {getGTAObjectFromObjName("des_traincrash_root1"),getGTAObjectFromObjName("des_traincrash_root2"),getGTAObjectFromObjName("des_traincrash_root3"),getGTAObjectFromObjName("des_traincrash_root4"),getGTAObjectFromObjName("des_traincrash_root5"),}, 0),
		SyncedAnimation("Crash Into Cargoplane TEST", "", true, std::vector<Animation> {getAnimationForShortcutIndex(49540),}, std::vector<Animation> {getAnimationForShortcutIndex(49541),getAnimationForShortcutIndex(49542),getAnimationForShortcutIndex(49544),getAnimationForShortcutIndex(49546),getAnimationForShortcutIndex(49548),}, std::vector<GTAObject> {getGTAObjectFromObjName("cargoplane"),getGTAObjectFromObjName("cropduster1_skin"),getGTAObjectFromObjName("cropduster2_skin"),getGTAObjectFromObjName("cropduster3_skin"),getGTAObjectFromObjName("cropduster4_skin"),}, 0),
		SyncedAnimation("Gas Station Explosion TEST", "", true, std::vector<Animation> {}, std::vector<Animation> {getAnimationForShortcutIndex(43936),getAnimationForShortcutIndex(43935),getAnimationForShortcutIndex(43937),}, std::vector<GTAObject> {getGTAObjectFromObjName("des_gasstation_skin01"),getGTAObjectFromObjName("des_gasstation_skin02"),getGTAObjectFromObjName("des_gasstation_tiles_root"),}, 0),
		SyncedAnimation("Prologue Tree Crash TEST", "", true, std::vector<Animation> {}, std::vector<Animation> {getAnimationForShortcutIndex(43596),}, std::vector<GTAObject> {getGTAObjectFromObjName("des_protree_root"),}, 0),
		SyncedAnimation("Destroy Wall TEST", "", true, std::vector<Animation> {}, std::vector<Animation> {getAnimationForShortcutIndex(43961),getAnimationForShortcutIndex(43962),getAnimationForShortcutIndex(43963),getAnimationForShortcutIndex(43965),getAnimationForShortcutIndex(43964),}, std::vector<GTAObject> {getGTAObjectFromObjName("des_smash2_root"),getGTAObjectFromObjName("des_smash2_root2"),getGTAObjectFromObjName("des_smash2_root3"),getGTAObjectFromObjName("des_smash2_root4"),getGTAObjectFromObjName("des_smash2_root005"),}, 0),
		SyncedAnimation("Cut Safe TEST", "", true, std::vector<Animation> {}, std::vector<Animation> {getAnimationForShortcutIndex(99319),getAnimationForShortcutIndex(99320),getAnimationForShortcutIndex(99321),}, std::vector<GTAObject> {getGTAObjectFromObjName("des_ranchsafe001_root"),getGTAObjectFromObjName("des_ranchsafe002_root"),getGTAObjectFromObjName("des_ranchsafe003_skin_root"),}, 0),
		SyncedAnimation("Prologue Tree Crash PT2 TEST", "", true, std::vector<Animation> {getAnimationForShortcutIndex(81148),getAnimationForShortcutIndex(81149),}, std::vector<Animation> {getAnimationForShortcutIndex(81169),}, std::vector<GTAObject> {getGTAObjectFromObjName("policeold2"),}, 0),
		SyncedAnimation("Tanker Crash TEST", "", true, std::vector<Animation> {}, std::vector<Animation> {getAnimationForShortcutIndex(43986),}, std::vector<GTAObject> {getGTAObjectFromObjName("des_tankercrash_01"),}, 0),
		SyncedAnimation("Tanker Explosion TEST", "", true, std::vector<Animation> {}, std::vector<Animation> {getAnimationForShortcutIndex(43987),getAnimationForShortcutIndex(43988),}, std::vector<GTAObject> {getGTAObjectFromObjName("des_tankerexplosion_01"),getGTAObjectFromObjName("des_tankerexplosion_02"),}, 0),
		SyncedAnimation("Cargo Ship Sinks TEST", "", true, std::vector<Animation> {}, std::vector<Animation> {getAnimationForShortcutIndex(43966),getAnimationForShortcutIndex(43969),getAnimationForShortcutIndex(43970),getAnimationForShortcutIndex(43967),getAnimationForShortcutIndex(43968),}, std::vector<GTAObject> {getGTAObjectFromObjName("root_scroll_anim_skel"),getGTAObjectFromObjName("des_shipsink_01"),getGTAObjectFromObjName("des_shipsink_02"),getGTAObjectFromObjName("des_shipsink_03"),getGTAObjectFromObjName("des_shipsink_04"),}, 0),
 };
}
