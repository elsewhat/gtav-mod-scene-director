...
void initializeSyncedAnimations() {
	gtaSyncedAnimations = {
		SyncedAnimation("Shower #6 (male)", std::vector<Animation> {getAnimationForShortcutIndex(13901),}, std::vector<Animation> {getAnimationForShortcutIndex(13904),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_shower_towel_s"),}, 0),
		SyncedAnimation("Shower #5 (male)", std::vector<Animation> {getAnimationForShortcutIndex(13881),}, std::vector<Animation> {getAnimationForShortcutIndex(13884),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_shower_towel_s"),}, 0),
		SyncedAnimation("Shower #4 (male)", std::vector<Animation> {getAnimationForShortcutIndex(13889),}, std::vector<Animation> {getAnimationForShortcutIndex(13892),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_shower_towel_s"),}, 0),
		SyncedAnimation("Shower #3 (male)", std::vector<Animation> {getAnimationForShortcutIndex(13885),}, std::vector<Animation> {getAnimationForShortcutIndex(13888),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_shower_towel_s"),}, 0),
		SyncedAnimation("Shower #2 (male)", std::vector<Animation> {getAnimationForShortcutIndex(13874),}, std::vector<Animation> {getAnimationForShortcutIndex(13877),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_shower_towel_s"),}, 0),
		SyncedAnimation("Shower #1 (male)", std::vector<Animation> {getAnimationForShortcutIndex(13905),}, std::vector<Animation> {getAnimationForShortcutIndex(13908),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_shower_towel_s"),}, 0),
		SyncedAnimation("Shower #6 (female)", std::vector<Animation> {getAnimationForShortcutIndex(13866),}, std::vector<Animation> {getAnimationForShortcutIndex(13869),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_shower_towel_s"),}, 0),
		SyncedAnimation("Shower #5 (female)", std::vector<Animation> {getAnimationForShortcutIndex(13854),}, std::vector<Animation> {getAnimationForShortcutIndex(13857),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_shower_towel_s"),}, 0),
		SyncedAnimation("Shower #4 (female)", std::vector<Animation> {getAnimationForShortcutIndex(13862),}, std::vector<Animation> {getAnimationForShortcutIndex(13865),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_shower_towel_s"),}, 0),
		SyncedAnimation("Shower #3 (female)", std::vector<Animation> {getAnimationForShortcutIndex(13858),}, std::vector<Animation> {getAnimationForShortcutIndex(13861),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_shower_towel_s"),}, 0),
		SyncedAnimation("Shower #2 (female)", std::vector<Animation> {getAnimationForShortcutIndex(13847),}, std::vector<Animation> {getAnimationForShortcutIndex(13850),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_shower_towel_s"),}, 0),
		SyncedAnimation("Shower #1 (female)", std::vector<Animation> {getAnimationForShortcutIndex(13870),}, std::vector<Animation> {getAnimationForShortcutIndex(13873),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_shower_towel_s"),}, 0),
		SyncedAnimation("Drink whiskey #5 shot", std::vector<Animation> {getAnimationForShortcutIndex(13944),}, std::vector<Animation> {getAnimationForShortcutIndex(13949),getAnimationForShortcutIndex(13951),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_whiskey_bottle"),getGTAObjectFromObjName("ex_p_ex_tumbler_01_s"),}, 0),
		SyncedAnimation("Drink whiskey #4 shot", std::vector<Animation> {getAnimationForShortcutIndex(13960),}, std::vector<Animation> {getAnimationForShortcutIndex(13965),getAnimationForShortcutIndex(13967),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_whiskey_bottle"),getGTAObjectFromObjName("ex_p_ex_tumbler_01_s"),}, 0),
		SyncedAnimation("Drink whiskey #3 shot", std::vector<Animation> {getAnimationForShortcutIndex(13980),}, std::vector<Animation> {getAnimationForShortcutIndex(13985),getAnimationForShortcutIndex(13987),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_whiskey_bottle"),getGTAObjectFromObjName("ex_p_ex_tumbler_01_s"),}, 0),
		SyncedAnimation("Drink whiskey #2 shot", std::vector<Animation> {getAnimationForShortcutIndex(13968),}, std::vector<Animation> {getAnimationForShortcutIndex(13973),getAnimationForShortcutIndex(13975),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_whiskey_bottle"),getGTAObjectFromObjName("ex_p_ex_tumbler_01_s"),}, 0),
		SyncedAnimation("Drink whiskey #1 shot", std::vector<Animation> {getAnimationForShortcutIndex(13952),}, std::vector<Animation> {getAnimationForShortcutIndex(13957),getAnimationForShortcutIndex(13959),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_whiskey_bottle"),getGTAObjectFromObjName("ex_p_ex_tumbler_01_s"),}, 0),
		...
		SyncedAnimation("Walk into vault", std::vector<Animation> {getAnimationForShortcutIndex(13627),}, std::vector<Animation> {getAnimationForShortcutIndex(13628),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_bank_vaultdoor"),}, 0),
		SyncedAnimation("Heist ruralbank", std::vector<Animation> {getAnimationForShortcutIndex(13617),getAnimationForShortcutIndex(13618),}, std::vector<Animation> {getAnimationForShortcutIndex(13619),getAnimationForShortcutIndex(13620),}, std::vector<GTAObject> {getGTAObjectFromObjName("hei_prop_hei_bankdoor_new"),getGTAObjectFromObjName("prop_bank_vaultdoor"),}, 0),
		SyncedAnimation("Lamar's introduction to multiplayer male", std::vector<Animation> {getAnimationForShortcutIndex(13530),getAnimationForShortcutIndex(13531),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Lamar's introduction to multiplayer female", std::vector<Animation> {getAnimationForShortcutIndex(13528),getAnimationForShortcutIndex(13529),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Exit door right", std::vector<Animation> {getAnimationForShortcutIndex(13426),}, std::vector<Animation> {getAnimationForShortcutIndex(13425),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_ss1_05_mp_door"),}, 0),
		SyncedAnimation("Exit door left", std::vector<Animation> {getAnimationForShortcutIndex(13422),}, std::vector<Animation> {getAnimationForShortcutIndex(13421),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_ss1_05_mp_door"),}, 0),
		SyncedAnimation("Enter door right", std::vector<Animation> {getAnimationForShortcutIndex(13418),}, std::vector<Animation> {getAnimationForShortcutIndex(13417),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_ss1_05_mp_door"),}, 0),
		SyncedAnimation("Enter door left #2", std::vector<Animation> {getAnimationForShortcutIndex(13414),}, std::vector<Animation> {getAnimationForShortcutIndex(13413),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_ss1_05_mp_door"),}, 0),
		SyncedAnimation("Enter door left #1", std::vector<Animation> {getAnimationForShortcutIndex(13411),}, std::vector<Animation> {getAnimationForShortcutIndex(13410),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_ss1_05_mp_door"),}, 0),
		SyncedAnimation("Enter house", std::vector<Animation> {getAnimationForShortcutIndex(13339),getAnimationForShortcutIndex(13402),getAnimationForShortcutIndex(13403),}, std::vector<Animation> {getAnimationForShortcutIndex(13401),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_ss1_05_mp_door"),}, 0),
		SyncedAnimation("Buzz in friend", std::vector<Animation> {getAnimationForShortcutIndex(13392),getAnimationForShortcutIndex(13393),}, std::vector<Animation> {getAnimationForShortcutIndex(13391),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_ss1_05_mp_door"),}, 0),
		SyncedAnimation("Car bomb install", std::vector<Animation> {getAnimationForShortcutIndex(13235),}, std::vector<Animation> {getAnimationForShortcutIndex(13234),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_bomb_01"),}, 0),
		...
		SyncedAnimation("Lap dance", std::vector<Animation> {getAnimationForShortcutIndex(13124),getAnimationForShortcutIndex(13123),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Purchase energydrink", std::vector<Animation> {getAnimationForShortcutIndex(13118),getAnimationForShortcutIndex(13119),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Purchase cigarette", std::vector<Animation> {getAnimationForShortcutIndex(13116),getAnimationForShortcutIndex(13117),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Purchase chocbar", std::vector<Animation> {getAnimationForShortcutIndex(13114),getAnimationForShortcutIndex(13115),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Purchase beerbox", std::vector<Animation> {getAnimationForShortcutIndex(13112),getAnimationForShortcutIndex(13113),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Purchase beer", std::vector<Animation> {getAnimationForShortcutIndex(13110),getAnimationForShortcutIndex(13111),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Store hold up cash", std::vector<Animation> {getAnimationForShortcutIndex(13107),}, std::vector<Animation> {getAnimationForShortcutIndex(13108),getAnimationForShortcutIndex(13109),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_money_bag_01"),getGTAObjectFromObjName("v_ret_gc_cashreg"),}, 0),
		SyncedAnimation("Jump out of van", std::vector<Animation> {getAnimationForShortcutIndex(12289),getAnimationForShortcutIndex(12290),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		...
		SyncedAnimation("Beatup dockworker idle", std::vector<Animation> {getAnimationForShortcutIndex(12261),getAnimationForShortcutIndex(12262),getAnimationForShortcutIndex(12263),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Beatup dockworker exit", std::vector<Animation> {getAnimationForShortcutIndex(12258),getAnimationForShortcutIndex(12259),getAnimationForShortcutIndex(12260),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Beatup dockworker main", std::vector<Animation> {getAnimationForShortcutIndex(12264),getAnimationForShortcutIndex(12265),getAnimationForShortcutIndex(12266),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Beatup dockworker intro", std::vector<Animation> {getAnimationForShortcutIndex(12267),getAnimationForShortcutIndex(12268),getAnimationForShortcutIndex(12269),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("misstrevor3 bike_chat_b_outro_1 outro", std::vector<Animation> {getAnimationForShortcutIndex(12245),getAnimationForShortcutIndex(12246),}, std::vector<Animation> {getAnimationForShortcutIndex(12247),getAnimationForShortcutIndex(12248),}, std::vector<GTAObject> {getGTAObjectFromObjName("hei_prop_hei_pic_ps_bike"),getGTAObjectFromObjName("hei_prop_hei_pic_ps_bike"),}, 0),
		...
		SyncedAnimation("misstrevor2mcs_3_b idle_peda", std::vector<Animation> {getAnimationForShortcutIndex(12230),getAnimationForShortcutIndex(12231),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		...
		SyncedAnimation("bikers_from_van_peda", std::vector<Animation> {getAnimationForShortcutIndex(12173),getAnimationForShortcutIndex(12174),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("bikers_from_van_ped_a", std::vector<Animation> {getAnimationForShortcutIndex(12171),getAnimationForShortcutIndex(12172),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("jump_out_of_van_ds", std::vector<Animation> {getAnimationForShortcutIndex(12169),getAnimationForShortcutIndex(12170),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		...
		SyncedAnimation("threaten_ortega_trev", std::vector<Animation> {getAnimationForShortcutIndex(12107),getAnimationForShortcutIndex(12106),getAnimationForShortcutIndex(12105),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Enter home #2", std::vector<Animation> {getAnimationForShortcutIndex(12066),}, std::vector<Animation> {getAnimationForShortcutIndex(12069),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_fh_door02"),}, 0),
		SyncedAnimation("Enter home #1", std::vector<Animation> {getAnimationForShortcutIndex(12062),}, std::vector<Animation> {getAnimationForShortcutIndex(12064),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_fh_door01"),}, 0),
		SyncedAnimation("Tattoo #2", std::vector<Animation> {getAnimationForShortcutIndex(14856),getAnimationForShortcutIndex(14857),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("shop_ig_5_b_player", std::vector<Animation> {getAnimationForShortcutIndex(12058),getAnimationForShortcutIndex(12059),}, std::vector<Animation> {getAnimationForShortcutIndex(12060),getAnimationForShortcutIndex(12057),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_ta_door"),getGTAObjectFromObjName("v_ilev_ta_door"),}, 0),
		SyncedAnimation("artist_finishes_up_his_tattoo_artist", std::vector<Animation> {getAnimationForShortcutIndex(12055),getAnimationForShortcutIndex(1253),}, std::vector<Animation> {getAnimationForShortcutIndex(12054),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_ta_door"),}, 0),
		...
		SyncedAnimation("mid_mission_inside_helicopter_lester ", std::vector<Animation> {getAnimationForShortcutIndex(12036),getAnimationForShortcutIndex(12037),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		...
		SyncedAnimation("Fine and dandy speech", std::vector<Animation> {getAnimationForShortcutIndex(12028),getAnimationForShortcutIndex(12029),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("CPR Cower", std::vector<Animation> {getAnimationForShortcutIndex(10904),getAnimationForShortcutIndex(10905),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("CPR", std::vector<Animation> {getAnimationForShortcutIndex(10902),getAnimationForShortcutIndex(10903),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Arm wrestling winner #2", std::vector<Animation> {getAnimationForShortcutIndex(6210),getAnimationForShortcutIndex(6212),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Arm wrestling winner #1", std::vector<Animation> {getAnimationForShortcutIndex(6206),getAnimationForShortcutIndex(6208),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Motorcycle knockout ?", std::vector<Animation> {getAnimationForShortcutIndex(5191),getAnimationForShortcutIndex(5192),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Car knockout ?", std::vector<Animation> {getAnimationForShortcutIndex(5188),getAnimationForShortcutIndex(5189),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Drink wheatgrass at safehouse", std::vector<Animation> {getAnimationForShortcutIndex(22897),}, std::vector<Animation> {getAnimationForShortcutIndex(2462),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_wheat_grass_glass"),}, -1),
		SyncedAnimation("Drink wine at safehouse #4", std::vector<Animation> {getAnimationForShortcutIndex(2487),}, std::vector<Animation> {getAnimationForShortcutIndex(2488),getAnimationForShortcutIndex(2490),getAnimationForShortcutIndex(2489),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_wine_bot_02"),getGTAObjectFromObjName("prop_wine_red"),getGTAObjectFromObjName("prop_sh_wine_glass"),}, -1),
		...
		SyncedAnimation("Drink beer at safehouse #4", std::vector<Animation> {getAnimationForShortcutIndex(2454),}, std::vector<Animation> {getAnimationForShortcutIndex(2455),getAnimationForShortcutIndex(2456),}, std::vector<GTAObject> {getGTAObjectFromObjName("ng_proc_beerbottle_01a"),getGTAObjectFromObjName("prop_beer_box_01"),}, -1),
		SyncedAnimation("Drink beer at safehouse #3", std::vector<Animation> {getAnimationForShortcutIndex(22905),}, std::vector<Animation> {getAnimationForShortcutIndex(2452),getAnimationForShortcutIndex(2453),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ret_ml_beerpis2"),getGTAObjectFromObjName("prop_beer_box_01"),}, -1),
		SyncedAnimation("Drink beer at safehouse #2", std::vector<Animation> {getAnimationForShortcutIndex(2449),}, std::vector<Animation> {getAnimationForShortcutIndex(2450),getAnimationForShortcutIndex(2451),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ret_ml_beerpis1"),getGTAObjectFromObjName("prop_beer_box_01"),}, -1),
		SyncedAnimation("Drink beer at safehouse #1", std::vector<Animation> {getAnimationForShortcutIndex(2446),}, std::vector<Animation> {getAnimationForShortcutIndex(2447),getAnimationForShortcutIndex(2448),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_beer_bottle"),getGTAObjectFromObjName("prop_beer_box_01"),}, -1),
		SyncedAnimation("Rollercoaster hands-up end", std::vector<Animation> {getAnimationForShortcutIndex(2423),getAnimationForShortcutIndex(2424),}, std::vector<Animation> {getAnimationForShortcutIndex(2425),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_roller_car_01"),}, 0),
		SyncedAnimation("Rollercoaster hands-up idle", std::vector<Animation> {getAnimationForShortcutIndex(2426),getAnimationForShortcutIndex(30746),}, std::vector<Animation> {getAnimationForShortcutIndex(2427),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_roller_car_01"),}, 0),
		SyncedAnimation("Rollercoaster hands-up start", std::vector<Animation> {getAnimationForShortcutIndex(2420),getAnimationForShortcutIndex(2421),}, std::vector<Animation> {getAnimationForShortcutIndex(2422),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_roller_car_01"),}, 0),
		SyncedAnimation("Rollercoaster exit", std::vector<Animation> {getAnimationForShortcutIndex(2418),getAnimationForShortcutIndex(2419),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Rollercoaster enter", std::vector<Animation> {getAnimationForShortcutIndex(2415),getAnimationForShortcutIndex(2416),}, std::vector<Animation> {getAnimationForShortcutIndex(2417),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_roller_car_01"),}, 0),
		...
		SyncedAnimation("Enter car panicked", std::vector<Animation> {getAnimationForShortcutIndex(8817),}, std::vector<Animation> {getAnimationForShortcutIndex(8816),}, std::vector<GTAObject> {getGTAObjectFromObjName("asea"),}, -1),
		...
		SyncedAnimation("Jimmy drugs michael #2", std::vector<Animation> {getAnimationForShortcutIndex(8735),getAnimationForShortcutIndex(8734),}, std::vector<Animation> {getAnimationForShortcutIndex(8733),}, std::vector<GTAObject> {getGTAObjectFromObjName("tailgater"),}, -0.2),
		SyncedAnimation("Jimmy drugs michael #1", std::vector<Animation> {getAnimationForShortcutIndex(8653),getAnimationForShortcutIndex(8651),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -0.2),
		...
		SyncedAnimation("Pull over ledge", std::vector<Animation> {getAnimationForShortcutIndex(8572),getAnimationForShortcutIndex(8573),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Yacht fight 2 (3/3 success)", std::vector<Animation> {getAnimationForShortcutIndex(8547),getAnimationForShortcutIndex(8548),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Yacht fight 2 (3/3 failure)", std::vector<Animation> {getAnimationForShortcutIndex(8539),getAnimationForShortcutIndex(8540),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Yacht fight 2 (2/3)", std::vector<Animation> {getAnimationForShortcutIndex(8544),getAnimationForShortcutIndex(8545),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Yacht fight 2 (1/3)", std::vector<Animation> {getAnimationForShortcutIndex(8541),getAnimationForShortcutIndex(8542),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Yacht fight 1 (3/3)", std::vector<Animation> {getAnimationForShortcutIndex(8537),getAnimationForShortcutIndex(8538),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Yacht fight 1 (2/3)", std::vector<Animation> {getAnimationForShortcutIndex(8535),getAnimationForShortcutIndex(8536),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Yacht fight 1 (1/3)", std::vector<Animation> {getAnimationForShortcutIndex(8533),getAnimationForShortcutIndex(8534),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Open door #2", std::vector<Animation> {getAnimationForShortcutIndex(8466),}, std::vector<Animation> {getAnimationForShortcutIndex(8488),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_trevtraildr"),}, 0),
		...
		SyncedAnimation("Blowjob, kneeling", std::vector<Animation> {getAnimationForShortcutIndex(8132),getAnimationForShortcutIndex(8130),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -1),
		SyncedAnimation("Hang and throw over ledge", std::vector<Animation> {getAnimationForShortcutIndex(8127),getAnimationForShortcutIndex(8128),}, std::vector<Animation> {}, std::vector<GTAObject> {}, -16.53),
		...
		SyncedAnimation("Get in passenger seat", std::vector<Animation> {getAnimationForShortcutIndex(8040),getAnimationForShortcutIndex(8043),}, std::vector<Animation> {getAnimationForShortcutIndex(8042),}, std::vector<GTAObject> {getGTAObjectFromObjName("asea"),}, -1),
		...
		SyncedAnimation("Exit car with rifles", std::vector<Animation> {getAnimationForShortcutIndex(7995),getAnimationForShortcutIndex(7996),}, std::vector<Animation> {getAnimationForShortcutIndex(7994),}, std::vector<GTAObject> {getGTAObjectFromObjName("dubsta"),}, -1),
		SyncedAnimation("Take crate from van", std::vector<Animation> {getAnimationForShortcutIndex(7977),}, std::vector<Animation> {getAnimationForShortcutIndex(7939),}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Close vault door", std::vector<Animation> {getAnimationForShortcutIndex(7930),}, std::vector<Animation> {getAnimationForShortcutIndex(7931),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_fin_vaultdoor_s"),}, 0),
		...
		SyncedAnimation("Open door #1", std::vector<Animation> {getAnimationForShortcutIndex(7779),}, std::vector<Animation> {getAnimationForShortcutIndex(7790),}, std::vector<GTAObject> {getGTAObjectFromObjName("v_ilev_fib_door1"),}, 0),
