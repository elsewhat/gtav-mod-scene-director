...
void initializeSyncedAnimations() {
	gtaSyncedAnimations = { 
		...
		SyncedAnimation("Upset talking in bed, exit 1", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17370),getAnimationForShortcutIndex(17376),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Upset talking in bed, exit 2", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17384),getAnimationForShortcutIndex(17379),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Upset talking in bed, loop 1", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17375),getAnimationForShortcutIndex(17373),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Upset talking in bed, loop 2", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17387),getAnimationForShortcutIndex(17385),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Gaming together", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17478),getAnimationForShortcutIndex(17477),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Gaming ragequit", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17475),getAnimationForShortcutIndex(17474),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Get out of bed, playful", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17482),getAnimationForShortcutIndex(17479),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Wave goodbye", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17491),getAnimationForShortcutIndex(17487),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		...
		SyncedAnimation("Pat on back", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17516),getAnimationForShortcutIndex(17515),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Open door for passenger", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17527),getAnimationForShortcutIndex(17524),}, std::vector<Animation> {getAnimationForShortcutIndex(17526),}, std::vector<GTAObject> {getGTAObjectFromObjName("tailgater"),}, 0),
		SyncedAnimation("No smoking allowed", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17531),getAnimationForShortcutIndex(17533),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		...
		SyncedAnimation("Show wedding ring to hooker", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17555),getAnimationForShortcutIndex(17554),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Read script on bed, loop", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17560),}, std::vector<Animation> {getAnimationForShortcutIndex(17562),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_cs_script_s"),}, 0),
		SyncedAnimation("Read script on bed, exit", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17556),}, std::vector<Animation> {getAnimationForShortcutIndex(17559),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_cs_script_s"),}, 0),
		SyncedAnimation("Rejected entry", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17566),getAnimationForShortcutIndex(17563),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Leave table and kiss, loop", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17573),getAnimationForShortcutIndex(17569),}, std::vector<Animation> {getAnimationForShortcutIndex(17571),getAnimationForShortcutIndex(17572),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_chateau_chair_01"),getGTAObjectFromObjName("prop_chateau_chair_01"),}, 0),
		SyncedAnimation("Leave table and kiss, exit", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17579),getAnimationForShortcutIndex(17574),}, std::vector<Animation> {getAnimationForShortcutIndex(17577),getAnimationForShortcutIndex(17578),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_chateau_chair_01"),getGTAObjectFromObjName("prop_chateau_chair_01"),}, 0),
		SyncedAnimation("Comfort while kneeling, loop", "", true, std::vector<Animation> {getAnimationForShortcutIndex(14746),getAnimationForShortcutIndex(14752),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Comfort while kneeling, exit", "", true, std::vector<Animation> {getAnimationForShortcutIndex(14745),getAnimationForShortcutIndex(14750),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Hold hostage, loop", "", true, std::vector<Animation> {getAnimationForShortcutIndex(14756),getAnimationForShortcutIndex(14753),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Hold hostage, victim killed", "", true, std::vector<Animation> {getAnimationForShortcutIndex(14755),getAnimationForShortcutIndex(14751),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		...
		SyncedAnimation("Annoy sunbathers", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17687),getAnimationForShortcutIndex(17686),getAnimationForShortcutIndex(17685),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Leave bar", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17705),getAnimationForShortcutIndex(17697),}, std::vector<Animation> {getAnimationForShortcutIndex(17698),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_cs_beer_bot_02"),}, 0),
		SyncedAnimation("Bear face smell?", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17718),getAnimationForShortcutIndex(17713),}, std::vector<Animation> {getAnimationForShortcutIndex(17717),}, std::vector<GTAObject> {getGTAObjectFromObjName("p_mr_raspberry_01_s"),}, 0),
		SyncedAnimation("Spooning with floyd, exit 1", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17732),getAnimationForShortcutIndex(17731),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Spooning with floyd, exit 2", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17735),getAnimationForShortcutIndex(17734),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Spooning with floyd, loop", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17738),getAnimationForShortcutIndex(17737),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Block photograph", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17749),getAnimationForShortcutIndex(17747),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Throw over bridge, loop", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17754),getAnimationForShortcutIndex(17755),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Throw over bridge, exit", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17757),getAnimationForShortcutIndex(17758),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Chase strippers out of club", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17765),getAnimationForShortcutIndex(17763),getAnimationForShortcutIndex(17764),getAnimationForShortcutIndex(17760),}, std::vector<Animation> {getAnimationForShortcutIndex(17762),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_strip_door_01"),}, 0),
		SyncedAnimation("Escorted out", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17792),getAnimationForShortcutIndex(17788),getAnimationForShortcutIndex(17790),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Console floyd #1", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17807),getAnimationForShortcutIndex(17805),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Console floyd #2", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17817),getAnimationForShortcutIndex(17815),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		...
		SyncedAnimation("Eat from trash", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17832),}, std::vector<Animation> {getAnimationForShortcutIndex(17831),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_taco_02"),}, 0),
		SyncedAnimation("Guitar beatdown", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17838),getAnimationForShortcutIndex(17835),}, std::vector<Animation> {getAnimationForShortcutIndex(17837),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_acc_guitar_01_d1"),}, 0),
		SyncedAnimation("Strumming guitar", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17839),}, std::vector<Animation> {getAnimationForShortcutIndex(17841),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_acc_guitar_01_d1"),}, 0),
		SyncedAnimation("Knockout against wall", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17855),getAnimationForShortcutIndex(17853),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Throw pineapple", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17890),getAnimationForShortcutIndex(17886),}, std::vector<Animation> {getAnimationForShortcutIndex(17889),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_pineapple"),}, 0),
		SyncedAnimation("Scare tramp", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17918),getAnimationForShortcutIndex(17917),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
		SyncedAnimation("Steal and throw food", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17938),getAnimationForShortcutIndex(17935),}, std::vector<Animation> {getAnimationForShortcutIndex(17937),}, std::vector<GTAObject> {getGTAObjectFromObjName("prop_taco_01"),}, 0),
		SyncedAnimation("Grab by throat, thow over railing", "", true, std::vector<Animation> {getAnimationForShortcutIndex(17974),getAnimationForShortcutIndex(17972),}, std::vector<Animation> {}, std::vector<GTAObject> {}, 0),
